...
public class Agent2 : Agent
{
...

    {
        ...
        nAgent.transform.position = new Vector3(-12, 0.5f, 12);//RollerAgent start location
        nAgent.ResetPath();
    ...
    {
        //nAgent.Stop();
        //UnityEngine.Debug.Log(nAgent.transform.position);
        ...
        if (workStatus_agent2 == false)
        {
            ...
            {
                agentDestination2 = targLoc1;//set Destination to  Target 1
                workStatus_agent2 = true;
                Operator1.targLoc1 = targLoc1;
                sensor.AddObservation(agentDestination2);
            }
            if (priority == 2 && targLoc2 != Vector3.zero)
            {
                agentDestination2 = targLoc2;//set Destination to  Target 2
                workStatus_agent2 = true;
                Operator1.targLoc2 = targLoc2;
                sensor.AddObservation(agentDestination2);
            }
            if (priority == 3 && targLoc3 != Vector3.zero)
            {
                agentDestination2 = targLoc3;//set Destination to  Target 3
                workStatus_agent2 = true;
                Operator1.targLoc3 = targLoc3;
                sensor.AddObservation(agentDestination2);
            }
            if (priority == 4 && targLoc4 != Vector3.zero)
            {
                agentDestination2 = targLoc4;//set Destination to  Target 4
                workStatus_agent2 = true;
                Operator1.targLoc4 = targLoc4;
                sensor.AddObservation(agentDestination2);
            }
            if (priority == 5 && targLoc5 != Vector3.zero)
            {
                agentDestination2 = targLoc5;//set Destination to  Target 5
                workStatus_agent2 = true;
                Operator1.targLoc5 = targLoc5;
                sensor.AddObservation(agentDestination2);
            }
            if (priority == 6 && targLoc6 != Vector3.zero)
            {
                agentDestination2 = targLoc6;//set Destination to  Target 6
                workStatus_agent2 = true;
                Operator1.targLoc6 = targLoc6;
                sensor.AddObservation(agentDestination2);
            }
            if (priority == 7 && targLoc7 != Vector3.zero)
            {
                agentDestination2 = targLoc7;//set Destination to  Target 7
                workStatus_agent2 = true;
                Operator1.targLoc7 = targLoc7;
                sensor.AddObservation(agentDestination2);
            }
            if (priority == 8)
            {
        ...
        {
            sensor.AddObservation(agentDestination2);
            if (Mathf.Abs(agentDestination2.x - nAgent.transform.position.x) < 1 && Mathf.Abs(agentDestination2.z - nAgent.transform.position.z) < 1)
            {
                nAgent.ResetPath();
                workStatus_agent2 = false;
            }
    ...
    public override void OnActionReceived(float[] vectorAction)//Method that commands next movement.
    {
        ...
        //}
        //AddReward(-0.000001f);//Negative reward to increse time performence
    }
