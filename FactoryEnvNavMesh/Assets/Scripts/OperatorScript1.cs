...
public class OperatorScript1 : Agent
{
...

    {
        ...
        nAgent.transform.position = new Vector3(-6, 1, 0);
        nAgent.ResetPath();
        rBody.position = new Vector3(-6, 1, 0);
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        ...
        if (workStatus_operator1 == false)
        {
            ...
            {
                operatorDestination1 = agent_targLoc1;//set Destination to  Target 1
                workStatus_operator1 = true;
                sensor.AddObservation(operatorDestination1);
            }
            if (priority == 2 && agent_targLoc2 != Vector3.zero)
            {
                operatorDestination1 = agent_targLoc2;//set Destination to  Target 2
                workStatus_operator1 = true;
                sensor.AddObservation(operatorDestination1);
            }
            if (priority == 3 && agent_targLoc3 != Vector3.zero)
            {
                operatorDestination1 = agent_targLoc3;//set Destination to  Target 3
                workStatus_operator1 = true;
                sensor.AddObservation(operatorDestination1);
            }
            if (priority == 4 && agent_targLoc4 != Vector3.zero)
            {
                operatorDestination1 = agent_targLoc4;//set Destination to  Target 4
                workStatus_operator1 = true;
                sensor.AddObservation(operatorDestination1);
            }
            if (priority == 5 && agent_targLoc5 != Vector3.zero)
            {
                operatorDestination1 = agent_targLoc5;//set Destination to  Target 5
                workStatus_operator1 = true;
                sensor.AddObservation(operatorDestination1);
            }
            if (priority == 6 && agent_targLoc6 != Vector3.zero)
            {
                operatorDestination1 = agent_targLoc6;//set Destination to  Target 6
                workStatus_operator1 = true;
                sensor.AddObservation(operatorDestination1);
            }
            if (priority == 7 && agent_targLoc7 != Vector3.zero)
            {
                operatorDestination1 = agent_targLoc7;//set Destination to  Target 7
                workStatus_operator1 = true;
                sensor.AddObservation(operatorDestination1);
            }
            if (priority == 8)
